...
public enum structureType {NOTHING, WOOD, WOOD_TOWER, WOOD_GATHERER, WOOD_PROCESSER, PATH,TOWER_BUILD_GRID,STONE,INNOCENT_HUMAN,STONE_GATHERER,STONE_PROCESSOR,PORTAL,HUMAN_GATHERER}
